...
while True:
    print("\n" + "="*40)
    print(" BOT DE GESTIÓN DE VACACIONES - MENU")
    print("="*40)
    ...
    if opcion == "1":
        print("""\nPara iniciar el trámite, por favor ingresá tu legajo. #"2002" en el ejemplo de uso""")
        ...
        if not empleado:
            print(" El legajo ingresado no existe en el sistema. Volviendo al menú.")
            continue
            
        print(f" Bienvenido/a {empleado['Nombre']} del sector {sector}.")
        print(f" Tu saldo disponible actual es de {empleado['Dias_Disponibles']} días.")
        
        if empleado['Dias_Disponibles'] <= 0:
            print(" No disponés de días suficientes para solicitar vacaciones. Trámite finalizado.")
            continue
        ...
        while True:
            ...
            try:
                ...
                print(" Formato de fecha inválido. Recordá usar el formato DD/MM/AAAA (Ej: 05/01/2027).")
        ...
        while True:
            ...
            try:
                ...
                print(" Formato de fecha inválido. Recordá usar el formato DD/MM/AAAA.")
        ...
        print(f" Estás solicitando un total de {dias_solicitados} días.")

        # --- VALIDACIÓN 1: SALDO DE DÍAS ---
        if dias_solicitados > empleado['Dias_Disponibles']:
            print(f" Solicitud Rechazada, Saldo insuficiente. Solicitaste {dias_solicitados} días pero solo disponés de {empleado['Dias_Disponibles']}.")
            continue
        ...
        if hay_superposicion:
            print(f" Solicitud Rechazada, Inviabilidad operativa. Las fechas se superponen con las vacaciones ya aprobadas de {con_quien} en tu mismo sector.")
            continue

        # --- CASO POSITIVO: PRE-APROBACIÓN ---
        print("\n Validaciones exitosas")
        print(" Solicitud PRE-APROBADA por el sistema.")
        print(f" Estado actualizado a 'Pendiente de aprobación'. Se derivó la notificación al Jefe de {sector} para el control humano final.")
        ...
        print(" Base de datos actualizada temporalmente.")
